			...
			<div id="wrapper">
						...
						<div class="inner">
							...
							<!-- Logo -->
								<a href="index.html" class="logo">
									<span class="symbol"><img src="/bookstore/resources/images/logo.svg" alt="" /></span><span class="title">Phantom</span>
								</a>
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<h1>${book.title}</h1>
							<span class="image main"><img src="/bookstore/resources/images/${book.bookId}.jpg" alt="" /></span>

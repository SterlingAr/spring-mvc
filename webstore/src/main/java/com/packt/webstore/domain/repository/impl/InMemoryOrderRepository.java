...
import com.packt.webstore.domain.Adress;
import com.packt.webstore.domain.Customer2;
...
public class InMemoryOrderRepository implements OrderRepository {
	...
	private long saveShippingDetail(ShippingDetail shippingDetail) {
		long addressId = saveAdress(shippingDetail.getShippingAdress());
	...
	private long saveCustomer(Customer2 customer) {

		long addressId = saveAdress(customer.getBillingAdress());
	...
	private long saveAdress(Adress address) {
		String SQL = "INSERT INTO ADRESS(DOOR_NO,STREET_NAME,AREA_NAME,STATE,COUNTRY,ZIP) "

...
public class InMemoryProductRepository implements ProductRepository {
	...
	public List<Product> getProductsByFilter(String category, String brand, Map<String, List<String>> filterParam) {
		...
		String SQL = "SELECT * FROM PRODUCTS WHERE CATEGORY IN (:category) AND "
				+ "UNIT_PRICE BETWEEN :low AND :high AND MANUFACTURER IN (:brand)";
		...
		filterParam.put("category", categories);
		filterParam.put("brand", brands);
	...
	public List<String> allowedConditions() {
		...
		List<String> allowedConditions = new ArrayList<String>();
		
		allowedConditions.add("New");
		allowedConditions.add("Old");
		allowedConditions.add("Refurbished");
